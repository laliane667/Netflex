...
// Create the dropdown menu
        ...
        buttonPanel.setLayout(new GridLayout(8, 1, 5, 20));
...
// Add the button panel to the sidebar
    ...
    public void reloadThumbnails(Video video, MenuController menuController, ProjectWindow projectWindow){
        ArrayList<Category> ids;
        ...
        carouselPanelContainer.repaint();
        /*for(Carousel carousel : carousels){
            carousel.reloadThumbnails(video);
        }*/
    }
